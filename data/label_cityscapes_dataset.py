...
import os.path
from data.label_pix2pix_dataset import LabelPix2pixDataset
from data.image_folder import make_dataset


class LabelCityscapesDataset(LabelPix2pixDataset):

    @staticmethod
    def modify_commandline_options(parser, is_train):
        parser = LabelPix2pixDataset.modify_commandline_options(parser, is_train)
    ...
    def get_paths(self, opt):
        ...
        if not opt.no_instance:
            ...
            instance1_paths = [p for p in label_paths_all if p.endswith('_instanceIds_1.png')]
        else:
            instance_paths = []

...
class LabelPix2pixDataset(BaseDataset):
    @staticmethod
    ...
    def __getitem__(self, index):
        ...
        label1_tensor = transform_label(label1) * 255.0
        label1_tensor[label1_tensor == 255] = self.opt.label_nc  # 'unknown' is opt.label_nc
        ...
        if self.opt.no_instance:
            ...
            instance1_path = self.instance1_paths[index]
            instance1 = Image.open(instance1_path)
            if instance.mode == 'L':
                instance_tensor = transform_label(instance) * 255
                instance_tensor = instance_tensor.long()
                instance1_tensor = transform_label(instance1) * 255
                instance1_tensor = instance1_tensor.long()
            else:
                instance_tensor = transform_label(instance)
                instance1_tensor = transform_label(instance1)
